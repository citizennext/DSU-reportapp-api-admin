                    ...
                    <div class="panel-body">
                        <table id="dataTable" class="table table-hover">
                            ...
                            @foreach($dataTypeContent as $data)
                                <tr>
                                    <td>{{$data->nume}}</td>
                                    <td>{{App\Judet::find($data->judet_id)->nume}}</td>
                                    ...
                                    <td class="no-sort no-click">
                                        @if (Voyager::can('delete_'.$dataType->name))<div class="btn-sm btn-danger pull-right delete" data-id="{{ $data->id }}" id="delete-{{ $data->id }}"><i class="voyager-trash"></i> Sterge</div> @endif
