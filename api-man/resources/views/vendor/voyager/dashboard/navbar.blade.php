        ...
        <div class="navbar-header">
            ...
            <ol class="breadcrumb hidden-xs">
                @if(count(Request::segments()) == 1)
                    <li class="active"><i class="voyager-activity"></i> {{ __('voyager.generic.dashboard') }}</li>
                @else
                    <li class="active">
                        <a href="{{ route('voyager.dashboard')}}"><i class="voyager-activity"></i> {{ __('voyager.generic.dashboard') }}</a>
                    </li>
                @endif
